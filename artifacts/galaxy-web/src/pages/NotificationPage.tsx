...
import { Notification, markNotificationRead, markAllNotificationsRead, clearNotifications } from "../lib/notificationService";
...
export default function NotificationPage({ user, notifications }: Props) {
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((n, i) => (
            <div
              ...
              style={{
                display: "flex", alignItems: "flex-start", gap: 12, padding: "14px 10px",
